...
* **Завеса (`runStora`)**: Программно активирует инструмент прямоугольника и цвет Dark grey, после чего эмулирует события мыши (`pointerdown`, `mousemove`, `pointerup`) на верхнем прозрачном холсте Zoom Canvas, заливая видимую область демонстрации.
